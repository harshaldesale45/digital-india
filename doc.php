...
<div class="container-fluid">
			<div class="center wow fadeInDown">
				...
				<h2>List of the doctors</h2>
				
			</div>
	
	
<h2>Select: </h2>
  <form action="docsort.php" method="post" class="form-inline">
	...
	&nbsp &nbsp
		...
		<div class="form-group">
      <label for="name" class="text-danger">SPECIALIST:</label>
      <input type="text" name="spec"  maxlength='50' class="form-control"  id="spec" placeholder="heart, ent,child specialist" required>
    </div>
	&nbsp &nbsp
	<button type='submit' name='submit1' value="submit1" class="btn btn-danger">Submit</button> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
		...
		<th class=td1>ADDRESS</th>
		 <th class=td1>YEARS OF EXPERIENCE</th>
			 ...
			 <th class=td1>RATING</th>
			  ...
			  <th class=td1>GET APPOINTMENT</th>
 </tr>
    </thead>";
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo "<tr>
	   ...
	   <td class='tdRed'>".$row["rating"]."</td>
	    <td class='tdRed'>"."<img align=top width=150px height=150px src=".$row["photo"]."></td>
	 <td class='tdRed'>"."<a href=".$row["appoin"].">Click here to get</a></td>";
